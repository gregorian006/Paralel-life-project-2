...
const Navbar = () => {
  ...
  return (
    // FUNGSI UTAMA GLASSMORPHISM ADA DI SINI:
    // fixed top-0: Menempel di atas
    // w-full: Lebar penuh
    // z-50: Agar selalu di atas elemen lain
    // backdrop-blur-md: Efek blur (buram) pada background di belakangnya
    // bg-[#0a0414]/70: Warna background hitam/ungu transparan (70% opacity)
